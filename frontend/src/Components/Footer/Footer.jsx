...
function Footer() {
  return (
    <footer className="bg-teal-950 pb-10">
        <div className="mx-auto w-full max-w-screen-xl px-28 py-6 lg:py-8">
            <>
                <img src="/logo.jpg" className="w-40" alt="FlowBite Logo" />
            </>
            <div className=" mt-10 grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
